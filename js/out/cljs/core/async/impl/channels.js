...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t28727 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t28727 = (function (val,box,meta28728){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t28727.cljs$lang$type = true;
cljs.core.async.impl.channels.t28727.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t28727";
cljs.core.async.impl.channels.t28727.cljs$lang$ctorPrWriter = (function (this__12667__auto__,writer__12668__auto__,opt__12669__auto__){return cljs.core._write.call(null,writer__12668__auto__,"cljs.core.async.impl.channels/t28727");
});
cljs.core.async.impl.channels.t28727.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t28727.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_28729){var self__ = this;
var _28729__$1 = this;return self__.meta28728;
});
cljs.core.async.impl.channels.t28727.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_28729,meta28728__$1){var self__ = this;
var _28729__$1 = this;return (new cljs.core.async.impl.channels.t28727(self__.val,self__.box,meta28728__$1));
});
cljs.core.async.impl.channels.__GT_t28727 = (function __GT_t28727(val__$1,box__$1,meta28728){return (new cljs.core.async.impl.channels.t28727(val__$1,box__$1,meta28728));
});
}
return (new cljs.core.async.impl.channels.t28727(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__12670__auto__,writer__12671__auto__,opts__12672__auto__){return cljs.core._write.call(null,writer__12671__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__12667__auto__,writer__12668__auto__,opt__12669__auto__){return cljs.core._write.call(null,writer__12668__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_28730 = self__.takes.pop();if((taker_28730 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_28730))
{var take_cb_28731 = cljs.core.async.impl.protocols.commit.call(null,taker_28730);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_28731,taker_28730,this$__$1){
return (function (){return take_cb_28731.call(null,null);
});})(take_cb_28731,taker_28730,this$__$1))
);
} else
{}
{
...
var putter_28732 = self__.puts.pop();if(!((putter_28732 == null)))
{var put_handler_28733 = putter_28732.handler;var val_28734 = putter_28732.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_28733))
{var put_cb_28735 = cljs.core.async.impl.protocols.commit.call(null,put_handler_28733);var __28736__$1 = cljs.core.async.impl.protocols.commit.call(null,handler);cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_28735,__28736__$1,put_handler_28733,val_28734,putter_28732,_,retval,this$__$1){
return (function (){return put_cb_28735.call(null,true);
});})(put_cb_28735,__28736__$1,put_handler_28733,val_28734,putter_28732,_,retval,this$__$1))
);
cljs.core.async.impl.protocols.add_BANG_.call(null,self__.buf,val_28734);
} else
{{
continue;
}
