...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_28721 = 0;while(true){
var m_28722 = cljs.core.async.impl.dispatch.tasks.pop();if((m_28722 == null))
{} else
{m_28722.call(null);
if((count_28721 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__28723 = (count_28721 + 1);
count_28721 = G__28723;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__12088__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__12088__auto__)
