...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__12667__auto__,writer__12668__auto__,opt__12669__auto__){return cljs.core._write.call(null,writer__12668__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_28686 = 0;while(true){
if((i_28686 < arr.length))
{(arr[i_28686] = null);
{
var G__28687 = (i_28686 + 1);
i_28686 = G__28687;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__12667__auto__,writer__12668__auto__,opt__12669__auto__){return cljs.core._write.call(null,writer__12668__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_28693 = (self__.level + 1);while(true){
if((i_28693 <= (new_level + 1)))
{(update[i_28693] = self__.header);
{
var G__28694 = (i_28693 + 1);
i_28693 = G__28694;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_28695 = 0;while(true){
if((i_28695 <= self__.level))
{var links_28696 = (update[i_28695]).forward;if(((links_28696[i_28695]) === x__$1))
{(links_28696[i_28695] = (x__$1.forward[i_28695]));
{
var G__28697 = (i_28695 + 1);
i_28695 = G__28697;
continue;
}
} else
{{
var G__28698 = (i_28695 + 1);
i_28695 = G__28698;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__12100__auto__ = (cljs.core.truth_((function (){var and__12088__auto__ = me;if(cljs.core.truth_(and__12088__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__12088__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__12100__auto__))
...
cljs.core.async.impl.dispatch.queue_delay.call(null,((function (timeout_channel,or__12100__auto__,timeout__$1,me){
return (function (){cljs.core.async.impl.timers.timeouts_map.remove(timeout__$1);
return cljs.core.async.impl.protocols.close_BANG_.call(null,timeout_channel);
});})(timeout_channel,or__12100__auto__,timeout__$1,me))
,msecs);
