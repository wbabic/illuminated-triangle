...
{{
var G__28859 = cljs.core.pop.call(null,v__$1);
v__$1 = G__28859;
continue;
}
} else
...
{var pred__28863 = cljs.core._EQ_;var expr__28864 = limit;if(cljs.core.truth_(pred__28863.call(null,1,expr__28864)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__28863.call(null,2,expr__28864)))
...
var G__28866 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__28867 = (limit__$1 - 1);
var G__28868 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__28866;
limit__$1 = G__28867;
parts = G__28868;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___28870 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___28870))
{var replacement_28871 = temp__4090__auto___28870;buffer.append([cljs.core.str(replacement_28871)].join(''));
} else
{buffer.append(ch);
}
{
var G__28872 = (index + 1);
index = G__28872;
continue;
}
}
